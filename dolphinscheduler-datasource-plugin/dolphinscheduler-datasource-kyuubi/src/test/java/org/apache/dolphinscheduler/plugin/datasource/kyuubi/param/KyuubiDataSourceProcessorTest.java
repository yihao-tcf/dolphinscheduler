...
public class KyuubiDataSourceProcessorTest {
    ...
    public void testCreateConnectionParams() {
        ...
        kyuubiDatasourceParamDTO.setPort(10015);
        kyuubiDatasourceParamDTO.setDatabase("defulat");
        kyuubiDatasourceParamDTO.setUserName("root");
        kyuubiDatasourceParamDTO.setPassword(null);
        ...
        Assert.assertEquals("jdbc:hive2://localhost:10015", connectionParams.getAddress());
        Assert.assertEquals("jdbc:hive2://localhost:10015/defulat", connectionParams.getJdbcUrl());
    }
    ...
    public void testCreateConnectionParams2() {
        String connectionJson =
                "{\"user\":\"root\",\"password\":\"\",\"address\":\"localhost\""
                        + ",\"database\":\"defulat\",\"jdbcUrl\":\"jdbc:hive2://localhost:10015/defulat\"}";
        KyuubiConnectionParam connectionParams = (KyuubiConnectionParam) kyuubiDatasourceProcessor
    ...
    public void testGetDatasourceDriver() {
        Assertions.assertEquals(DataSourceConstants.ORG_APACHE_KYUUBI_JDBC_HIVE_DRIVER,
    ...
    public void testGetJdbcUrl() {
        ...
        kyuubiConnectionParam.setJdbcUrl("jdbc:postgresql://localhost:1234/default");
        kyuubiConnectionParam.setOther("other");
        Assert.assertEquals("jdbc:postgresql://localhost:1234/default?other",
                kyuubiDatasourceProcessor.getJdbcUrl(kyuubiConnectionParam));

    }

    @Test
    public void testGetDbType() {
        Assert.assertEquals(DbType.KYUUBI, kyuubiDatasourceProcessor.getDbType());
    }
